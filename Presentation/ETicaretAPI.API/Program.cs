using GOAL.API.Configurations.ColumnWriters;
using GOAL.API.Extensions;
using GOAL.API.Filters;
using GOAL.Application;
using GOAL.Application.Validators.Products;
using GOAL.Infrastructure;
using GOAL.Infrastructure.Filters;
using GOAL.Infrastructure.Services.Storage.Azure;
using GOAL.Infrastructure.Services.Storage.Local;
using GOAL.Infrastructure.Services.Storage.Minio;
using GOAL.Persistence;
using GOAL.SignalR;
using GOAL.SignalR.Hubs;
